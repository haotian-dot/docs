...
具体示例请参见 [配置文件格式与样例-输出测试结果文件](../8-regression/9-yaml-sample.md#save-artifacts)。
...
你可以配置文件的「script」字段中使用命令将文件输出到 `/cos/outputs` 目录下作为测试输出，具体示例请参见 [配置文件格式与样例-输出影子模式文件](../8-regression/9-yaml-sample.md#generate-shadow-mode)。
